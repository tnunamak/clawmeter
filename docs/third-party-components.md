...
| `internal/tray/icons/provider-antigravity.png` | Antigravity provider tray mark | Rasterized from pinned CodexBar `ProviderIcon-antigravity.svg` ([source](https://github.com/steipete/CodexBar/blob/cc8da27cec92029a6435bfee4a703a719290234e/Sources/CodexBar/Resources/ProviderIcon-antigravity.svg)); identity checked against [Google Antigravity](https://antigravity.google/) | The pinned CodexBar checkout distributes this resource under its repository [MIT license](https://github.com/steipete/CodexBar/blob/cc8da27cec92029a6435bfee4a703a719290234e/LICENSE), which permits copying the copyrighted resource with attribution. The Antigravity mark remains a trademark; no trademark license is claimed. |
...
| `internal/tray/icons/provider-alibaba.png` | Alibaba provider tray mark | Rasterized from pinned CodexBar `ProviderIcon-alibaba.svg` ([source](https://github.com/steipete/CodexBar/blob/main/Sources/CodexBar/Resources/ProviderIcon-alibaba.svg)) | The pinned CodexBar checkout distributes this resource under its repository [MIT license](https://github.com/steipete/CodexBar/blob/main/LICENSE), which permits copying the copyrighted resource with attribution. The Alibaba mark remains a trademark; no trademark license is claimed. |

The PNGs are fixed 128px RGBA assets and are downscaled at runtime for tray
sizes. Antigravity, JetBrains, Synthetic, and z.ai are alpha-preserving rasterizations of
