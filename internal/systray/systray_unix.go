...
import (
	...
	"github.com/tnunamak/clawmeter/internal/systray/internal/generated/menu"
...
// SetIconName sets the icon by name, using a freedesktop icon theme directory.
// themePath should be the root of an icon theme (containing hicolor/).
// iconName should be the icon name without extension (e.g. "clawmeter-green").
